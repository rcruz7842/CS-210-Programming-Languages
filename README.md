...
This repository contains projects and assignments that I completed for CS-210 Programming Languages at Southern New Hampshire University.

Throughout this course, I worked with C++ and learned how to build programs using classes, functions, file input and output, exception handling, and other programming concepts. The projects in this repository show the progress I made throughout the course and how my problem-solving and coding skills developed over time.
...
These projects gave me hands-on experience writing, testing, and debugging C++ programs while applying the programming concepts I learned throughout the course.

---

# Featured Project: Corner Grocer Item Tracker
...
This project brought together many of the concepts I learned throughout the course. Instead of practicing one concept at a time, I had to combine them to build a program that solved a realistic problem.
...
I probably spent the most time figuring out how to use a map effectively. Once I understood that each grocery item could be used as the key and its purchase count could be stored as the value, the rest of the program became much easier to build.
